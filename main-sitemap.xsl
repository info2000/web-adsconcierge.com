			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Facebook ads optmization tool</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Facebook ads optmization tool</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://adsconcierge.com/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
